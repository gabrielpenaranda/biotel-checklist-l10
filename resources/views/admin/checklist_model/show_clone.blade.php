    ...
    <div class="container">
        <div class="row">
            <div class="col-8 offset-1">
                <h4 class="">Clonar Modelo de Checklist</h4>
            </div>
            <div class="col-2">
        ...
        <form action="{{ route('checklist-model.clone', ['checklist_model' => $checklist_model->id]) }}" method="POST">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-10 offset-1">
                    <label for="new_name" class="text-9 font-weight-bold">Nombre del modelo clonado</label>
                </div>
            </div>
            <div class="row">
                <div class="col-7 offset-1">
                    <div class="form-group">
                        <input type="text" name="new_name" class="text-9 form-control">
                    </div>
                </div>
                <div class="col-3">
                    @can('checklist-model.clone')
                        <button type="submit" class="btn btn-primary btn-sm">Clonar Modelo de Checklist</button>
                    @endcan
                </div>
            </div>
        </form>
