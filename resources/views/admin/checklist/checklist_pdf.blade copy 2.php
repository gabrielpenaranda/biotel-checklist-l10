...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <table class="table table-striped table-sm">
                <thead class="thead-dark">
                    <th class="text-center text-9">Fecha 1<sup>ra</sup> Verificación</th>
                    <th class="text-center text-9">Fecha 2<sup>da</sup> Verificación</th>
                </thead>
                <tbody>
                    <tr>
                        <td class="text-center text-9">
        ...
        <div class="col-12">
            <table class="table table-striped table-sm">
                <thead class="thead-dark">
                    ...
                    <th class="text-center text-9">Observaciones</th>
                    <th class="text-center text-9">
