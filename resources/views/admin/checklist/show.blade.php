...
@section('content')
    ...
    <div class="row mt-3">
        ...
        <div class="col-3">
            @can('checklist.pdf')
            <a class="btn btn-b-danger btn-sm" href="{{ route('checklist.pdf', ['checklist' => $checklist->id]) }}">Generar PDF</a>
            @endcan
            @can('checklist.index')
    ...
    <div class="row">
        ...
        @else
            <br>
            <h5 class="text-center">No se encontraron elementos de checklist</h5>
        @endif
        </div>
    </div>
    </div>
