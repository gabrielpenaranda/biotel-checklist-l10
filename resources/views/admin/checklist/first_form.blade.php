...
<div class="container">
    <div class="row mt-3">
        <div class="col-8 offset-1">
            @if ($checklist->employee_id == 1)
                <h4 class="">Asignar Usuario (1<sup>ra</sup> Verificación)</h4>
            @else
                <h4 class="">Reasignar Usuario (1<sup>ra</sup> Verificación)</h4>
            @endif
        </div>
        <div class="col-2">
    ...
    <form action="{{ route('checklist.first-update', ['checklist' => $checklist->id]) }}" method="POST">
        {{ method_field('PUT') }}
        {{ csrf_field() }}
            ...
            <div class="col-10 offset-1">
                <div class="form-group">
                    ...
                    <select name="user_id" class="form-control text-9">
                        @foreach ($users as $u)
                        @if ($u->id != 1 && $checklist->supervisor_id != $u->id)
        ...
        <div class="row">
            <div class="col-10 offset-1">
                ...
                <button type="submit" class="btn btn-primary btn-sm">Asignar Empleado</button>
                @endcan
            </div>
        </div>
        <br>
